...
<head>
    ...
    <title>DepartmentAdmin</title>
</head>
<body>
    <?php
        session_start();
        if(!isset($_GET['dept']) || ($_GET['dept'] != $_SESSION['id'])){
            session_unset();
        }else{
            ...
            $data = new Data($db);
            $d = $_GET['dept'];
            $query = "SELECT * FROM departments WHERE dept_id=$d";
                ...
                <div class="mainDash">
                    <div class="analysis">
                        ...
                        <div class="boxes" id="elections">
                            ...
                            <div class="info">
                                <h2 id='FacultyElections'>0</h2>
                                <p>Faculty Elections</p>
                            </div>
                        </div>
                        <div class="boxes" id="elections">
                            <i class="fas fa-poll-h"></i> 
    ...
    <script src="DashboardJS/deptDash.js"></script>
    <script src="DashboardJS/deptAPI.js"></script>
</body>
</html>