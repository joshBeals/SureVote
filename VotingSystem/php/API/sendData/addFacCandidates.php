<?php
    ...
    if(isset($_POST)){
        ...
        if($data[0] == '' || $data[1] == '' || $data[2] == '' || $data[3] == '' || $data[4] == ''){
            ...
            // Create Table
            $query = "CREATE TABLE IF NOT EXISTS faculty_election_candidates (
            ...
            if($stmt->execute()){
                $query = "SELECT * FROM faculty_election_candidates WHERE candidate_name='$data[0]' and election_id=$data[3]"; 
                ...
                if($stmt->execute()){
                    ...
                    if($num > 0){
                        ...
                        $query = 'INSERT INTO faculty_election_candidates
                        SET 
                        ...
                        $stmt->bindParam(':dept_id', $data[2]);
                        $stmt->bindParam(':position_id', $data[4]);
                        $stmt->bindParam(':election_id', $data[3]);
