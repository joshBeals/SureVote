<?php
    ...
    if(isset($_POST)){
        ...
        if($data[0] == '' || $data[1] == '' || $data[2] == '' || $data[3] == ''){
            ...
            if($stmt->execute()){
                $query = "SELECT * FROM dept_election_candidates WHERE candidate_name='$data[0]' and election_id=$data[2]";
                ...
                if($stmt->execute()){
                    ...
                    if($num > 0){
                        ...
                        $query = 'INSERT INTO dept_election_candidates
                        SET 
                        ...
                        $stmt->bindParam(':position_id', $data[3]);
                        $stmt->bindParam(':election_id', $data[2]);
