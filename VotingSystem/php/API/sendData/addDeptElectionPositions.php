<?php
    ...
    if(isset($_POST)){
        ...
        if($data[0] == '' || $data[1] == ''){
            ...
            // Create Table
            $query = "CREATE TABLE IF NOT EXISTS dept_election_positions (
            ...
            if($stmt->execute()){
                $query = "SELECT * FROM dept_election_positions WHERE position_name='$data[0]' and election_id=$data[1]";  
                ...
                if($stmt->execute()){
                    ...
                    if($num > 0){
                        ...
                        $query = 'INSERT INTO dept_election_positions
                        SET 
